...
class HotelResourceOperator extends Controller
{
    ...
    public function index()
    {
        ...
        return view('operator.hotel.index', compact('hotels','Countries'));
    }
    ...
    {  //$roomcategories = RoomCategory::All();
       ...
       $Countries = Country::where('status', 'ACTIVE')->get();
       return view('operator.hotel.create', compact('roomtypes', 'amenities','Countries','venders'));
    }
    ...
    public function edit($id)
    {
        try {
            ...
            $Cities = City::where('region_id', $hotel->region_id)->where('status', 'ACTIVE')->get();
             ...
             return view('operator.hotel.edit',compact('hotel', 'amenities','hotelamenity','hotelroomcategoires','roomtypes','hotelgalleries', 'Countries', 'Regions', 'Cities','venders' ));
        } catch (ModelNotFoundException $e) {
            return $e;
        }
    }
