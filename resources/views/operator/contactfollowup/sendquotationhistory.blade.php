              ...
              <table id="multi-select" class="display">
                <thead>
                  <tr>
                    ...
                    <th class="" >Quoration PDF</th>  
                    <th class="" >Send Date</th>  
                  </tr>
                </thead>
                <tbody>
                @foreach($sendquotations as $sendquotation)
                
                <tr>
                    <td> {{ $sendquotation->send_quotation_no }}</td>
                    <td> {{ $sendquotation->name }}</td>
                    <td> {{ $sendquotation->mobile }}</td>
                    <td> {{ $sendquotation->email }}</td>
                    <td> {{ $sendquotation->cost }}</td>
                    <td> {{ $sendquotation->checkin }}</td>
                    <td> {{ $sendquotation->checkout }}</td>
                    <td> <a href="https://ensoberfiles.s3.amazonaws.com/quotations/{{ $sendquotation->send_quotation_no }}.pdf" target="_blank"><i class="material-icons ">visibility</i></a></td> 
					<td> {{ date('d-m-Y, H:i:s', strtotime($sendquotation->created_at)) }}</td>
                  </tr>
                @endforeach
                </tbody>
                <tfoot>
                  <tr>
                    ...
                    <th class="" >Send Date</th>  
                    <th class="" >Send Time</th> 
                  </tr>
                </tfoot>
              </table>
              <div class="pagination">{{$sendquotations->links()}}</div>
            </div>
