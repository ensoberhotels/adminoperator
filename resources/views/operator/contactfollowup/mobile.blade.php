...
@section('styles')
	<style>
		...
		i.material-icons.left.hidesbtn {
			transition: 0.5s;
		}
		i.material-icons.left.con_less {
			transform: rotate(180deg);
		}
		.carousel-fixed-item.center.middle-indicator.next_per_btn {
			float: left;
			width: 65px;
			position: fixed;
			bottom: 35px;
		...
		.carousel-fixed-item.center.middle-indicator.next_per_btn button {
			border: 1px solid;
			border-radius: 100%;
			height: 25px !important;
			width: 25px;
		}
		.carousel-fixed-item.center.middle-indicator.next_per_btn button i {
			float: left;
			padding: 0;
			margin: 0;
			line-height: 1px;
		...
		.carousel.carousel-slider.center.intro-carousel {
        ...
        <div class="card-content">
			<div class="row">
				...
				<div class=" active custom_tab_main tab_border">
					<div class="col s12">
						<ul class="custom_tabs custom_tab_div">
							<li class="custom_tab">
								<a class="@if(Request::segment(2) == 'contactfollowup') active @endif;" href="{{URL::to('/operator/contactfollowup/mobileview')}}">New <b style="color:#000;">{{$newcount}}</b></a>
							</li>
							<li class="custom_tab">
								<a class="@if(Request::segment(2) == 'pastcontactfollowup') active @endif;" href="{{URL::to('/operator/pastcontactfollowup/mobileview')}}">Past <b style="color:#000;">{{$pastcount}}</b></a>
							</li>
							<li class="custom_tab">
								<a class="@if(Request::segment(2) == 'todaycontactfollowup') active @endif;" href="{{URL::to('/operator/todaycontactfollowup/mobileview')}}">Today <b style="color:#000;">{{$todaycount}}</b></a>
							</li>
							<li class="custom_tab">
								<a class="@if(Request::segment(2) == 'futurecontactfollowup') active @endif;" href="{{URL::to('/operator/futurecontactfollowup/mobileview')}}">Future <b style="color:#000;">{{$futurecount}}</b></a>
							</li> 
						</ul>
					</div>
				</div> 
				...
				<div class="col s12">
			        <div class="contact_search">
				        <form class="add_hotel_group_rate_form" id="add_hotel_group_rate_form" method="GET" action="mobileview" >
									{{csrf_field()}}
							<div class="col s10">
                            ...
                            <div class="input-field col s2">
                            	<button class="btn waves-effect waves-light right" style="height: 30px !important;" type="submit" name="action" id="add_followup"><i class="material-icons right">search</i>
                            	</button>
                            </div>
				...
				<div class="col s12">	
					...
					@foreach($AssignContacts as $AssignContact)
						<div class="slider_main carousel-item slide-@php $i  @endphp">
							<div class="col s5">
								<lable style="float: left;text-align: left;">Client Mobile</lanle>
								<input type="text" class="validate invalid" value="{{$AssignContact->mobile}}" readOnly/>
							</div>
							<div class="col s5">
								<lable style="float: left;text-align: left;">Client Name</lanle>
								<input type="text" class="validate invalid" value="{{$AssignContact->name}}" readOnly/>
							</div>							
							<div class="input-field col s2">
								<lable style="float: left;text-align: left;"></lanle>
								<i class="material-icons left hidesbtn" style="font-size: 35px; margin-top:20px;" onclick="contactDeatilShowHide()">keyboard_arrow_down</i>
							</div>
							...
							<div class="contact_main">
								<ul class="contact_deatils">
									...
									<li>
										...
										<input type="hidden" value="Operator-{{ $operator_name[0] }}" id="source" />
										<input type="hidden" value="{{ $operator_id[0] }}" id="con_operator_id" />
									</li>		
									<li>
							...
							<div class="col s12 add_fade @if($AssignContact->favorite_status == 'favorite') favorite_contact @endif">		
								<div class="input-field">
									<textarea cols="" rows="" id="comment" name="comment" class="comment_box" required style="height:80px;"></textarea>
									<label>Commnent Select</label> 
								</div>
								<div class="col s6">
									<lable style="float: left;text-align: left;">FollowUp Date</lanle>
								...
								<div class="col s6">
									<lable style="float: left;text-align: left;">Status</lanle>
								...
								<div class="col s6">
									<lable style="float: left;text-align: left;">Favorite Status</lanle>
								...
								<div class="input-field col s12" style="text-align:center;">
									...
									@endif
									<a class="mb-6 btn waves-effect waves-light purple lightrn-1 right" style="float: left !important;" target="_blank" href="/operator/sendemail/{{$AssignContact->id}}">Send Email
											<i class="material-icons right">send</i>
										</a>
								</div>
							</div>
							<div class="input-field col s12 add_fade">
				...
				<div class="carousel-fixed-item center middle-indicator next_per_btn" >
					<div class="left">
...
@section('scripts')
   ...
   <!-- BEGIN PAGE LEVEL JS-->
    ...
    <!-- END PAGE LEVEL JS-->
  <script>
	// contact detail show hide
	function contactDeatilShowHide(){
		jQuery(".contact_main").toggle();
		jQuery(".hidesbtn").toggleClass('con_less');
	}
