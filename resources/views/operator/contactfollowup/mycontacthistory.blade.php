            ...
            <div class="col s12">
              <table id="multi-select" class="display">
                ...
                <tr>
                    ...
                    <td> {{ $Contact->follow_up_date }}</td>
                    <td style=""> 
						<div class="">
							<a href="javascript:void(0)" class="show_comment">Comment</a>
							<div class="comment_main" style="display:none; width:300px;"> 
							<ul id='' class=''>
								@foreach($Contact->followUpComment as $comment)
                    ...
                    <td style="text-align: center;"> 
						@if($Contact->status == 'COMPLETE')
							<b class="status_btn_g">{{ $Contact->status }}</b>
						@elseif($Contact->status == 'CLOSE')
							<b class="status_btn_y">{{ $Contact->status }}</b>
						@elseif($Contact->status == 'INACTIVE')
							<b class="status_btn_r">{{ $Contact->status }}</b>
...
@section('scripts')
    ...
    $(document).ready(function() {
		...
		jQuery(".show_comment").click(function(){
			jQuery(this).parent().find(".comment_main").slideToggle();
		});
        ...
        // alert("My favourite programming languages are: -- " + contact_ids + " ---  assign to -- "+assign_to);
      $.ajaxSetup({
                  headers: {
