											...
											<div class="">
												...
												<div class="voucher_details" style="display: @if(@$quotation[0]->quotation_type == 'voucher') {{ 'block' }} @else {{'none'}} @endif">
													...
													<div class="col s12 m6 {{$con_class}}">
														...
														<input type="checkbox" value="Y" name="room_inventory_checkbox" id="room_inventory_checkbox" style="opacity: 1;position: unset;width: 15px !important;height: 15px !important; pointer-events: auto;" @if(@$quotation[0]->room_inventory_checkbox == 'Y') {{ 'checked' }} @endif>
													</div>
