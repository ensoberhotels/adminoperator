								...
								<table class="table" style="font-size:12px;color:#000;">
									...
									<tbody>
										...
										<tr>
											...
											<td>
												<button type="button" class="btn waves-effect gradient-45deg-red-pink waves-light" onclick="showPaymentHistory('{{$order->send_quotation_no}}');">Payment</button><br>
												@if($order->closed_f_owner == '1') 
													<span style="background-color: green; padding: 1px 10px; color: #fff; border-radius: 3px;">Closed</span>
												@else
													<a href="/operator/acceptorderfromowner/{{$order->send_quotation_no}}" target="_blank">
														<button type="submit" class="btn waves-effect gradient-45deg-red-pink waves-light" >Accepte</button>
													</a>
												@endif
											</td>
										</tr>
