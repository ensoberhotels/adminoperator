                ...
                <div class="card-content">
					...
					<div class="row" id="details"> 
						<form class="form-inline" action="#" >
							...
							<input type="text" class="form-control mb-2 mr-sm-2" id="a_voucher_no" placeholder="Enter Activity Voucher No" name="a_voucher_no" style="width:130px !important;">
												...
												<div class="daywaise_info" id="daywaise_info">
													<div class="col s12 m4">
														...
														<select name="activity_id" class="" id="activity_id" tabindex="0"> 
															...
															<option value="{{$activity->id}}">{{$activity->activity_cat}}</option>
															@endforeach
														</select>          
													</div>
													<div class="col s12 m4">
													...
													<div class="col s12 m4">
														<label for="arrival_city" class="">Activity Zone</label>
														<select name="activity_id" class="activity_list" id="activity_list" tabindex="0"> 
															<option>Select Activity Zone</option>
														</select>          
													</div>
													<div class="col s12 m5">
														<label for="date" class="">Date</label>
														<input type="date" name="date" id="date" class="filter_date" autocomplete="off">
													</div>
													<div class="col s12 m4">
														<label for="night" class="" title="No Of Nights">Slot</label>
														<select name="slot" id="slot" class="slot" tabindex="0">
															<option>Select Slot</option>
															<option value="morning_slot">Morning</option>
															<option value="evening_slot">Evening</option>
														</select>
													</div>
													<div class="col s12 m3">
														<label for="slot_time" class="">Time</label>
														<input type="text" name="time" id="slot_time" class="filter_date disabled" autocomplete="off">
													</div>
													<div class="col s12 m4">
														<label for="adult" class="" title="No Of Adults">Adults</label>
														<input type="number" name="adult" id="adult" onkeyup="setTotalVisitor();" onblur="setTotalVisitor();" onchange="setTotalVisitor();">
													</div> 
																				
													<div class="col s12 m4">
														<label for="kids" class="" title="Kids (5-12 Years) with bed" style="font-size: 11px !important;">Kids</label>
														<input type="number" name="kids" id="kids" onkeyup="setTotalVisitor();" onblur="setTotalVisitor();" onchange="setTotalVisitor();">       
													</div>
													
													<div class="col s12 m4">
														<label for="total_visitor" class="">Total Visitor</label>
														<input type="number" name="total_visitor" class="disabled" id="total_visitor">
													</div>
													<div class="col s6 s6">
										...
										<div class="collapsible-body">
											<div class="">
												<div class="col s6 m3">
													...
													<span style="color:red; font-size:11px;" class="mr_mrs_error"></span>
												</div>
												<div class="col s12 m4">
													<label for="name" class="">Name</label>
													<input type="text" name="client_name" id="name" value="Guest">
												</div>
																			
												<div class="col s12 m5">
													<label for="mobile" class="">Mobile</label>
													<input type="number" name="mobile" id="mobile" value="8383908656">       
												</div>
												...
												<div class="col s12 m6">
													...
													<input type="email" name="ccemail" id="ccemail" value="Pragya@ensoberhotels.com">
												</div> 
												<div class="col s12 m6">
												...
												<div class="col s12 m6 advance_received_input">
												...
												<div class="col s12 m6 advance_received_input_hide">
													...
													<input type="text" name="no_of_jeeps" id="no_of_jeeps">
												</div>
												
												<div class="col s12 comment_for_advance_div">
													<label for="comment_for_advance" class="">Comment For Advance</label>
													<textarea name="comment_for_advance" id="comment_for_advance" ></textarea>
												</div>
												
												<div class="col s12">
													<label for="pickup_point" class="">Pickup Point</label>
													<input type="text" name="pickup_point" id="pickup_point" value="Corbett Panorama Resort">
												</div>
												<div class="col s12">
												...
												<div class="col s12 m12 send_q_btn_area" style="text-align: center; margin-top: 5px !important;">
													<input type="hidden" id="activity_voucher_no" />
													...
													<button type="button" class="btn waves-effect gradient-45deg-red-pink waves-light hide don_voucher" onclick="downloadActivityVoucher();" style="">Download</button>
												</div>
											</div>
										</div>
									</li>
...
@section('scripts')
    ...
    <script>
		...
		function redirectVoucherToUpdateMode(voucher_no){
			window.location.href = "/operator/makeactivityvoucher/"+voucher_no;
		}
		jQuery(document).ready(function(){
			// Open Basic Info
			jQuery("#basic_info").addClass("active");
			jQuery("#basic_info .collapsible-body").show();
