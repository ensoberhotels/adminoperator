			...
			<div class="row">
				<div class="box">
					...
					@else
						...
						<div class="col s12 m6">
							@if(count($hotels)>1)
								<select class="form-control hotel_list" id="hotel_id" onchange="getRoomBookingStatus();">
					...
					<div class="col s4 m3">
						...
						<select class="form-control" id="s_year" onchange="getRoomBookingStatus();">
							@foreach($years as $year)
							<option value="{{$year->year}}" @if(Request::get('year') == $year->year || date('Y') == $year->year) {{ 'selected' }} @endif>{{$year->year}}</option>
							@endforeach
						</select>
					</div>
					<div class="col s3 m5">
						<label for="to_date" class="active">Month</label>
						<select class="form-control" id="s_month" onchange="getRoomBookingStatus();">
							...
							<option value="05" @if(Request::get('month') == '06' || date('m') == '05') {{ 'selected' }} @endif>May</option>
					...
					<div class="col s1">
						<br>
						<span id="refresh_btn">
							<i class="material-icons icon" onclick="getRoomBookingStatus();" style="cursor: pointer;">refresh</i>
						</span>
					</div>
				</div>
