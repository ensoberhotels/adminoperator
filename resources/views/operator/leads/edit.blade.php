...
@section('content')
    ...
    <div class="">
        <div class="">
            ...
            <form class="add_hotel_group_rate_form" id="add_hotel_group_rate_form" method="POST" action="{{ route('leads.update',$lead->id) }}" >
            {{csrf_field()}}
                    ...
                    <div class="row group">
                        ...
                        <div class="col s11"> 
                            <div class="col s3">
                                ...
                                <input class="validate invalid" required="" aria-required="true" id="mobile" type="number" name="mobile" autocomplete="off" value="{{ $lead->mobile }}" >
                            </div>
                            ...
                            <div class=" col s3" id="reference_name_field"  @if( $lead->lead_source == 'Travel Agent' || $lead->lead_source == 'Reference')  @else  style="display: none;" @endif>
                            ...
                            <div class=" col s3">
                                ...
                                <input class="validate invalid" aria-required="true" id="email" type="email" name="email" value="{{ $lead->email }}">
                            </div>
                            <div class=" col s3">
                           ...
                           <!-- <div class=" col s3">
                            ...
                            <div class=" col s3">    
                                ...
                                <select id="customer_type" name="customer_type">
                                  <option value="" @if( $lead->customer_type == '') selected @endif>Select Lead Type</option>
                ...
                <div class="row group">
                  <div class="col s11">
                         <div class=" col s3">
                            ...
                            <div class=" col s3" id="hotel_enquiry" @if( $lead->enquiry_type == 'Own Hotel' || $lead->enquiry_type == 'Partner Hotel')  @else  style="display: none;" @endif >
                            ...
                            <div class=" col s3" id="other_enquiry_field"  @if( $lead->enquiry_type == 'Other')  @else  style="display: none;" @endif>
                        ...
                        <div class=" col s3 city_list get_suc_cat">
                         ...
                         <div class=" col s3">    
							<label for="lead_status" class="">Select Lead</label>
                         ...
                         <div class=" col s3" id="closed_reason_field" @if( $lead->lead_status == 'CLOSED')  @else  style="display: none;" @endif>
                         ...
                         <div class=" col s3" id="lead_comment_field" >
                  ...
                  <div class="col s12">
					<div class="card-header">
					   ...
					   <div class=" col s12 m2">
							...
							<input class="validate invalid" required="" aria-required="true" id="name" type="date" name="followup_date" value="{{$lead->followup_date}}">
						</div>
						<div class=" col s12 m2">
							<label for="name" class="">Followup Time</label>
							<input class="validate invalid" required="" aria-required="true" id="name" type="time" name="followup_time" value="{{$lead->followup_time}}">
						</div>
						<div class=" col s12 m2">
