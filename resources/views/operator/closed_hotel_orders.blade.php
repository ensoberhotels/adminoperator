								...
								<table class="table" style="font-size:12px;color:#000;">
									...
									<tbody>
										...
										<tr>
											...
											<td>
												<span class="{{$order->checkin_checkout_status}}">{{$order->checkin_checkout_status}}</span>
											</td>
										</tr>
										<tr>
											<td colspan="15" class="{{$order->send_quotation_no}}" style="font-size:12px;border: 1px solid #eee;background-color: #2962ff0d; display:none;" border="1">
