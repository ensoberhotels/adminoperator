                    ...
                    <div>
                        ...
                        {{ csrf_field() }}
                               <input type="hidden" name="_method" value="DELETE">
                                <button class="mb-6 btn-floating waves-effect waves-light gradient-45deg-purple-deep-orange car_delete gradient-shadow" title="Delete" onclick="return confirm('Are you sure?')" disabled>
                                    <i class="material-icons">delete_sweep</i>
                                </button>
                                </form>
                                <!--<a href="{{ url('admin/viewhotel123453') }}" onclick="showview('{{$hotel->id}}')">-->
                                <a href="{{ url('operator/viewhotel/'.$hotel->id) }}">
                                <button class="mb-6 btn-floating waves-effect waves-light gradient-45deg-light-blue-cyan car_delete gradient-shadow" >
                                    <i class="material-icons">remove_red_eye</i>
                                </button>
                                </a>
                                <!--<a href="{{ route('hotel.edit',$hotel->id) }}" disabled>-->
                                <a href="#" disabled>
                                    <button class="mb-6 btn-floating waves-effect waves-light gradient-45deg-green-teal gradient-shadow" disabled><i class="material-icons">brush</i></button>
                                </a>
