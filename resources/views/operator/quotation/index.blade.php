  ...
  <!-- Multi Select -->
	...
	<div class="">
		...
		<div class=" active custom_tab_main" id="">
			<div class="col s12">
				<ul class="custom_tabs">
					...
					<li class="custom_tab">
						<a class="active" href="{{URL::to('/operator/quotation/')}}">Quotation</a>
					</li>
					<li class="custom_tab">
      ...
      <div class="col s12 m6 l3">
       @if($new_count>0) <a class="active" href="{{URL::to('/operator/quotation/?quotation=new')}}"> @endif
         <div class="card animate fadeLeft">
            <div class="card-content cyan white-text">
               <p class="card-stats-title"><i class="material-icons">person_outline</i> New Quotation</p>
      ...
      <div class="col s12 m6 l3">
      @if($active_count>0) <a class="active" href="{{URL::to('/operator/quotation/?quotation=active')}}"> @endif
       
         <div class="card animate fadeLeft">
            <div class="card-content red accent-2 white-text">
               <p class="card-stats-title"><i class="material-icons">attach_money</i>Active Quotation</p>
      ...
      <div class="col s12 m6 l3">
      @if($hot_count>0) <a class="active" href="{{URL::to('/operator/quotation/?quotation=hot')}}"> @endif
      
         <div class="card animate fadeRight">
            <div class="card-content orange lighten-1 white-text">
               <p class="card-stats-title"><i class="material-icons">trending_up</i> Hot Quotation</p>
      ...
      <div class="col s12 m6 l3">
      @if($follow_up_count>0) <a class="active" href="{{URL::to('/operator/quotation/?quotation=follow_up')}}"> @endif
      
         <div class="card animate fadeRight">
            <div class="card-content green lighten-1 white-text">
               <p class="card-stats-title"><i class="material-icons">content_copy</i> Follow Up Quotation Reminders</p>
      ...
      <div class="col s12 m6 l3">
       @if($inactive_count>0) <a class="active" href="{{URL::to('/operator/quotation/?quotation=inactive')}}"> @endif
     
         <div class="card animate fadeRight">
            <div class="card-content lime lighten-2 lighten-1 white-text">
               <p class="card-stats-title"><i class="material-icons">content_copy</i> Lost Quotation</p>
            ...
            <div class="col s12">
              <table id="multi-select" class="display">
                ...
                <tr>
                    ...
                    <td>{{ $quotation->lead_no }}</td>
                    <td style="width:100px;">{{ date('d M Y', strtotime($quotation->create_date)) }}</td>
                    <td> {{ $quotation->mobile }}</td>
                    <td style="width:10%;"> {{ $quotation->email }}</td>
                    <td> {{ $quotation->name }}</td>
                    <td style="width:15%;"> {{ $quotation->location }}</td>
                    <td> {{ $quotation->lead_priority }}</td>
                    <td style="width:100px;">{{ date('d M Y', strtotime($quotation->start_date)) }}</td>
                    <td style="width:100px;">{{ date('d M Y', strtotime($quotation->end_date)) }}</td>
                    
                    <td>
                        <div class="switch">
                          <label onchange="change_status('{{$quotation->id}}','Quotation')" >
                    ...
                    <form action="{{ route('quotation.destroy', $quotation->id) }}" method="POST" style="display: inline-block;">
                        {{ csrf_field() }}
						...
						<br>
                        <span id="make_a_sale_{{$quotation->id}}">
                          @if($quotation->make_sale == '0')
							 <button class="buttons-html5 mb-6 btn waves-effect waves-light gradient-45deg-light-blue-cyan" tabindex="0" aria-controls="multi-select" title="MAKE A SALE" onclick="make_sale('{{$quotation->id}}')"><span>MAKE A SALE</span></button><br>  
                          @endif
                        </span><br>
						
						<a href="{{ url('operator/makeitineraryv1/'.$quotation->lead_id) }}">
							<button class=" buttons-html5 mb-6 btn waves-effect gradient-45deg-red-pink waves-light car_delete" tabindex="0" aria-controls="multi-select" title="Update"><span>Make Itinerary</span></button>
						</a><br>
						
						<a href="{{ url('/operator/lead/followup/'.$quotation->lead_id) }}">
