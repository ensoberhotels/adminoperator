										...
										<div class="collapsible-body">
											<div class="">
												...
												<!--<h6 class="final_cost_val"></h6>-->
													...
													<button type="button" class="btn waves-effect gradient-45deg-red-pink waves-light generate_send_quo" onclick="generateQuotation();">Generate</button>
...
@section('scripts')
    ...
    <script>
		...
		function redirectToUpdateMode(quotation_no){
			window.location.href = "/operator/makequotation/"+quotation_no;
		}
