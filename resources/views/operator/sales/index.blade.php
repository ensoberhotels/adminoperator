            ...
            <div class="row">
              <div class="col s10 m6 l6">
                ...
                <ol class="breadcrumbs mb-0">
                  ...
                  <li class="breadcrumb-item"><a href="#">All Sale</a>
                  </li>
                </ol>
              </div>
		...
		<div class=" active custom_tab_main" id="">
			<div class="col s12">
				<ul class="custom_tabs">
					<li class="custom_tab">
						<a class="" href="{{URL::to('/operator/leads/')}}">Lead</a>
					</li>
					<li class="custom_tab">
						<a class="" href="{{URL::to('/operator/quotation/')}}">Quotation</a>
					</li>
					<li class="custom_tab">
						<a class="active" href="{{URL::to('/operator/sales/')}}">Sale</a>
					</li>
					<li class="custom_tab">
			...
			<div class="clable_main">
				<div class="clable">
					<a class="active" href="@if($new_count>0){{URL::to('/operator/leads/?sale=new')}} @else {{ '#' }}@endif"> 
				...
				<div class="clable color1">
					<a class="active" href="@if($unpaid_count>0){{URL::to('/operator/sales/?sale=unpaid')}} @else {{ '#' }}@endif"> 
					<div class="clable_text">
						Unpaid Sales
					</div>
					<div class="clable_value">
				...
				<div class="clable color2">
					<a class="active" href="@if($paid_count>0){{URL::to('/operator/sales/?sale=paid')}} @else {{ '#' }}@endif"> 
					<div class="clable_text">
						Paid Sales
					</div>
					<div class="clable_value">
				...
				<div class="clable color3">
					<a class="active" href="@if($follow_up_count>0){{URL::to('/operator/sales/?sale=follow_up')}} @else {{ '#' }}@endif"> 
					<div class="clable_text">
						Follow Up
					</div>
					<div class="clable_value">
              ...
              <table id="multi-select" class="display">
                ...
                <tr>
                    ...
                    <form action="{{ route('sales.destroy', $sale->id) }}" method="POST" style="display: inline-block;">
                        ...
                        <span id="make_a_sale_{{$sale->id}}">
                          
                                <button class="buttons-html5 mb-6 btn waves-effect waves-light gradient-45deg-light-blue-cyan" tabindex="0" aria-controls="multi-select" title="MAKE A SALE" onclick="make_sale('{{$sale->id}}')"><span>MAKE A BOOKED</span></button>
                          
                        </span>
						
						<a href="{{ url('/operator/lead/followup/'.$sale->lead_id) }}">
