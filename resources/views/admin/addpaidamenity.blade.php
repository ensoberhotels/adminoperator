...
@section('content')
    ...
    <div class="row">
        <div class="col s12">
            <div class="card">
                <div class="card-content" style="padding-bottom:300px;">
                    <div class="card-header">
                        <h4 class="card-title">Create Paid Amenity</h4>
                    </div>
					
					
			<form class="add_hotel_form" id="add_hotel_form" method="POST" action="{{ url('/admin/addamenityaction') }}" enctype='multipart/form-data'>
			{{csrf_field()}}
              <div class="row">
				...
				<div class="input-field col s4">
				  <select class="validate invalid" required="" aria-required="true" id="property_type" name="amenity_id">
				...
				<div class="input-field col s4">
					<select id="city" name="amount_type" tabindex="-1">
						<option value="" selected>Amount Type</option>
				...
				<div class="input-field col s4">
					...
					<input class="validate" required="" aria-required="true" id="price" type="text" name="price">
                </div>
    		...
    		$('#details').append(`<div class="row group">
						<div class="col s11">
							<div class="input-field col s4 show_select">
								<select id="type" name="type[]" tabindex="-1" required="">
									<option value="" selected>Select Room Category</option>
									<option value="Standered Room">Standered Room</option>
