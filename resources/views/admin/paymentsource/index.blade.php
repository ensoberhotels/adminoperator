            ...
            <div class="row">
              <div class="col s10 m6 l6">
                ...
                <ol class="breadcrumbs mb-0">
                  <li class="breadcrumb-item"><a href="index.html">Hotel Payment Source</a>
                  </li>
                  <li class="breadcrumb-item"><a href="#">All Hotel Payment Source</a>
                  </li>
                </ol>
              </div>
    ...
    <div class="col s12">
      <div class="card">
        ...
        <div class="col s12 m2">
         ...
         <select id="hotel_id" name="hotel_id" class="hotel_id select2"> 
            <option value="">Select Contact Type</option>
            @foreach($hotels as $hotel)
               <option value="{{ $hotel->id }}" @if (app('request')->input('hotel_id')== $hotel->id ) selected @endif>{{ $hotel->hotel_name }}</option>
            @endforeach
         </select>
        </div>
        ...
        <div class=" col s12 m2">
         ...
         <div class=" col s12 m2">
           <a href="/admin/paymentsource"><button id="search_hotel" class="btn cyan waves-effect waves-light right" type="button">Clear Search
           </button></a>
         </div>
        </div>
        </form>
          ...
          <div class="row">
            <div class="col s12">
              <table id="multi-select" class="display">
                <thead>
                  <tr>
					<th class="tooltipped " data-position="top" data-tooltip="Hotel Name">Hotel Name</th>
                    <th class="tooltipped " data-position="top" data-tooltip="Payment Source">Payment Source</th>    
					<th class="tooltipped " data-position="top" data-tooltip="Payment Source Code">Payment Source Code</th>
					<th class="tooltipped " data-position="top" data-tooltip="Owner Payment Source">Owner Payment Source</th> 
                    <th class="no-sort">Status</th>
                    <th class="no-sort">Action</th>
                  </tr>
                </thead>
                <tbody>
                @foreach($hotel_payment_source as $payment_source)
                
                <tr>
                    <td>{{ $payment_source->hotel->hotel_name }}</td>
					<td>{{ $payment_source->source }}</td>
					<td>{{ $payment_source->code }}</td>
					<td>@if($payment_source->owner == 0){{'NO'}} @elseif($payment_source->owner == 1){{'YES'}}@endif</td>
                    <td>
                        <div class="switch">
                          <label onchange="change_status('{{$payment_source->id}}','PaymentSource')" >
                            @if($payment_source->status == 'ACTIVE')
                    ...
                    <form action="{{ route('paymentsource.destroy', $payment_source->id) }}" method="POST" style="display: inline-block;">
                        {{ csrf_field() }}
                        ...
                        <a href="{{ route('paymentsource.edit',$payment_source->id) }}">
              ...
              <div class="pagination">{{$hotel_payment_source->links()}}</div>
            </div>
          </div>
        </div>
      </div>
