    ...
    <div class="col s12 m6 l6 ">
      <div id="basic-form" class="card card card-default scrollspy">
        <div class="card-content">
          ...
          <form class="col s12" id="add_operator_form" method="post" action="{{URL::to('/admin/addoperatoraction')}}">
			{{csrf_field()}}
            <div class="row">
            ...
            <div class="row">
              ...
              <div class="row">
                <div class="input-field col s12">
                  <button class="btn cyan waves-effect waves-light right" type="submit" name="action" id="add_operator">Submit
...
@section('scripts')
	<script>
      ...
      jQuery(document).ready(function(){
		...
		jQuery("#add_operator").click(function(){
            var formData = jQuery('#add_operator_form').serialize();
            console.log(formData);
            jQuery.ajax({
               type: "post",
               //dataType : "json",
               //contentType: "application/json; charset=utf-8",
               url: "{{URL::to('/admin/addoperatoraction')}}",
               data: formData,
               success: function(res){
                  console.log(res);
				  alert("Successfull");
