            ...
            <div class="card">
                <div class="card-content">
                    <div class="card-header">
                        <h4 class="card-title">Create Activity Zone</h4>
                    </div>
					
					
			<form class="add_car_form" id="add_car_form" method="POST" action="{{ route('activitysubcat.store') }}" enctype="multipart/form-data" role="form">
			{{csrf_field()}}
              <div class="row">
                <div class="col s12 m3">
					<label for="activity_cat_id" >Activity Name</label>
				...
				<div class=" col s12 m3">
					<label for="activity_subcat" class="">Activity Zone *</label>
					<input class="validate invalid" required="" aria-required="true" id="activity_subcat" type="text" name="activity_subcat">
                </div>
