...
@section('content')
    ...
    <div class="row">
        <div class="col s12">
			...
			<form class="add_car_form" id="add_car_form" method="POST" action="{{route('activitysubcat.update', $activitysubcat->id )}}" enctype="multipart/form-data" role="form">
			{{csrf_field()}}
			<input type="hidden" name="_method" value="PATCH">
              <div class="row">
                <div class="col s12 m3">
					<label for="activity_cat_id" >Activity Cat</label>
				...
				<div class="col s12 m3">
				  <div class="col s12 m12 activity_name">
					<label for="activity_name_id" >Activity Name</label>
