...
@section('content')
    ...
    <div class="row">
        <div class="col s12">
			...
			<form class="add_hotel_form" id="add_hotel_form" method="POST" action="{{ url('/admin/addhotelseasonrateaction') }}" enctype='multipart/form-data'>
			{{csrf_field()}}
              <div class="row"> 
					...
					<div class="row group">
						<div class="col s11"> 
							<div class="input-field col s4">
								<select name="room_category_id[]" class="validate invalid" required="" aria-required="true" id="room_category_id">
									@foreach($roomcategories as $roomcategory)
										<option value="{{ $roomcategory->id }}">{{ $roomcategory->type }} ( {{ $roomcategory->name }} )</option>
									@endforeach
								</select>
							</div>
							<div class="input-field col s4">
