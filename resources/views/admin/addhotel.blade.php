...
@section('content')
    ...
    <div class="row">
        <div class="col s12">
			...
			<form class="add_hotel_form" id="add_hotel_form" method="POST" action="{{ url('/admin/addhotelaction') }}" enctype='multipart/form-data'>
			{{csrf_field()}}
              <div class="row">
				...
				<div class="input-field col s4">
					...
					<select class="validate" required="" aria-required="true" id="country" name="country">
				...
				<div class="input-field col s4">
					...
					<select class="validate" required="" aria-required="true" id="state" name="state">
