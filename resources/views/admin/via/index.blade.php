              ...
              <table id="multi-select" class="display">
                ...
                @foreach($vias as $via)
                 <tr>
                    ...
                    <td>{{ $via->startDistination->name }}</td>
                    <td>{{ $via->toDistination->name }}</td>
                    <td>{{ $via->via }}</td>
                    <td>{{ $via->distance }}</td>
                    <td>{{ $via->duration }}</td>
                    <td>
                        <div class="switch">
                          <label onchange="change_status('{{$via->id}}','Via')" >
                            @if($via->status == 'ACTIVE')
                    ...
                    <form action="{{ route('via.destroy', $via->id) }}" method="POST" style="display: inline-block;">
                        {{ csrf_field() }}
