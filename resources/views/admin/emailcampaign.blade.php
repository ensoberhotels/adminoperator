            ...
            <div class="row">
              <div class="col s10 m6 l6">
                ...
                <ol class="breadcrumbs mb-0">
                  <li class="breadcrumb-item"><a href="index.html">Email</a>
                  </li>
                  <li class="breadcrumb-item"><a href="#">Email Campaigns</a>
                  </li>
                </ol>
              </div>
    ...
    <div class="col s12">
      <div class="card">
        <div class="card-content">
			<div class="row">
				<div class="col s6">
					<h4 class="card-title">All Email Campaign</h4>
				</div>
              ...
              <table id="multi-select" class="display">
				...
				@foreach($datas as $data)
                  <tr>
                    ...
                    <td>{{ $data->title }}</td>
                    <td>{{ count(explode(',', $data->contact_ids)) }}</td>
                    <td>
						<div class="switch">
						  <label>
                    ...
                    <td>
						<a href="/admin/deletecampaign/{{$data->id}}" class="mb-6 btn-floating waves-effect waves-light gradient-45deg-purple-deep-orange" title="Delete">
							<i class="material-icons">delete_sweep</i>
						</a>
						<a href="/admin/updatecampaign/{{$data->id}}" ><button class="mb-6 btn-floating waves-effect waves-light gradient-45deg-green-teal gradient-shadow"><i class="material-icons">brush</i></button></a>
					</td> 
                  </tr>
				@endforeach
                </tbody>
