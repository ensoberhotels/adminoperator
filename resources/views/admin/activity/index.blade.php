              ...
              <table id="multi-select" class="display">
                <thead>
                  <tr>
                    ...
                    <th class="no-sort">Event Approved</th>
				...
				@foreach($activities as $activity)
                  <tr>
                    ...
                    <td>{{ @$activity->activityCat['activity_cat'] }}</td>
                    <td>{{ @$activity->activityName->activity_name }}</td>
                    <td>{{ @$activity->activitySubCat->activity_subcat }}</td>
                    <td>{{ @$activity->countryName->name }}</td>
                    <td>{{ @$activity->stateName->name }}</td>
                    <td>{{ @$activity->cityName->name }}</td>
                    <td>{{ $activity->price }} </td>
                    <td>{{ @$activity->venderName->name }} </td>
                    
                    <td>
						<div class="switch">
						  <label onchange="change_status('{{$activity->id}}','Activity')" >
                    ...
                    <td>
                        <div class="switch">
                          <label onchange="change_approvel('{{$activity->id}}','Activity')">
                            @if($activity->vender_approved == 1)
                                <input checked="" type="checkbox">
                            @else
                                <input type="checkbox">
                            @endif
