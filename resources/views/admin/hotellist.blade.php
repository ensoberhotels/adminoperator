					...
					<div id="basic-form" class="card card card-default scrollspy">
						...
						<div class="card-content">
							...
							<div class="button_area">
								...
								<button class="mb-6 btn-floating waves-effect waves-light gradient-45deg-light-blue-cyan car_delete" title="Delete" onclick="return confirm('Are you sure?')">
									<i class="material-icons">remove_red_eye</i>
								</button>
								
								<a href="/admin/operator/9/edit">
