...
@section('content')
    ...
    <div class="row">
        <div class="col s12">
            ...
            <form class="add_hotel_group_rate_form" id="add_hotel_group_rate_form" method="POST" action="{{ route('lead.store') }}" >
            {{csrf_field()}}
              <div class="row">
                    ...
                    <div class="row group">
                        <div class="col s12"> 
                            ...
                            <div class=" col s12 m2">
								...
								<input name="number" id="mobile" onkeyup="if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,'')" name="mobile">
                           ...
                           <!-- <div class=" col s12 m2">
                            ...
                            <div class=" col s12 m2 show_select">    
                                ...
                                <select id="customer_type" name="customer_type">
                                  <option value="" @if( old('customer_type') == '') selected @endif>Select Customer Type</option>
							...
							<div class=" col s12 m2 show_select">
								...
								<select id="enquiry_type" name="enquiry_type" required>
								  <option value="" @if( old('enquiry_type') == '') selected @endif>Select Enquiry Type</option>
                            ...
                            <div class=" col s12 m2 show_select">
								...
								<select id="enquiry_type" name="enquiry_type">
								  ...
								  <option value="WHATSAPPEMAIL" selected>WHATSAPP & EMAIL</option>
						...
						<div class=" col s12 m2 show_select">    
                               <label for="trip_type" class="">Trip Type</label>
                                <select id="trip_type" name="trip_type">
                                  <option value="" @if( old('trip_type') == '') selected @endif>Select Trip Type</option>
                                  <option value="Single" @if( old('trip_type') == 'Single') selected @endif>Single</option>
                                  <option value="Return" @if( old('trip_type') == 'Return') selected @endif>Return</option>
                                  </select>  
                            </div>
