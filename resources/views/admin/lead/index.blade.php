              ...
              <table id="multi-select" class="display">
                <thead>
                  <tr>
                    ...
                    <th class="tooltipped " data-position="top" data-tooltip="Hotel Name">Lead Number</th>
                    <th class="tooltipped " data-position="top" data-tooltip="Start Date" style="width: 80px;">Date </th>
                    <th class="tooltipped " data-position="top" data-tooltip="End Date">Lead Source</th>
                    <th class="tooltipped " data-position="top" data-tooltip="From No Person">Enquiry Type </th>                  
                    <th class="tooltipped " data-position="top" data-tooltip="To No Person">Mobile</th>                  
                    <th class="tooltipped " data-position="top" data-tooltip="Single Sharing Price" style="width: 100px;">Email</th>                  
                    <th class="tooltipped " data-position="top" data-tooltip="Double Sharing Price">Guest Name</th>                  
                    <th class="tooltipped " data-position="top" data-tooltip="Triple Sharing Price" style="width: 150px;">Location</th>                  
                    <th class="tooltipped " data-position="top" data-tooltip="Quad Sharing Price">Lead Priority</th>                  
                    <th class="tooltipped " data-position="top" data-tooltip="Penta Sharing Price" style="width: 80px;">Start Date</th>                  
                    <th class="tooltipped " data-position="top" data-tooltip="Penta Sharing Price" style="width: 80px;">End Date</th>                  
                ...
                <tr>
                    ...
                    <td>{{ $lead->lead_no }}</td>
                    <td>{{(isset($lead->create_date) ? date('d M Y', strtotime($lead->create_date)) :'') }}</td>
                    ...
                    <td>{{ (isset($lead->create_date) ? date('d M Y', strtotime($lead->start_date)) :'') }}</td>
                    <td>{{ (isset($lead->create_date) ? date('d M Y', strtotime($lead->end_date)) :'') }}</td>
