      ...
      <div class="card">
					  ...
					  <div class="col s12 m6 l3">
						 <div class="card animate fadeLeft">
							<div class="card-content cyan white-text">
							   <p class="card-stats-title"><i class="material-icons">person_outline</i> Total Lead</p>
							   <h4 class="card-stats-number white-text">{{$active_lead_count}}</h4>
							</div>
						 </div>
					  </div>
					  <div class="col s12 m6 l3">
						 <div class="card animate fadeLeft">
							<div class="card-content red accent-2 white-text">
							   <p class="card-stats-title"><i class="material-icons">person_outline</i>Total Quotation</p>
							   <h4 class="card-stats-number white-text">{{$active_quotation_count}}</h4>
							</div>
						 </div>
					  </div>
					  <div class="col s12 m6 l3">
						 <div class="card animate fadeRight">
							<div class="card-content orange lighten-1 white-text">
							   <p class="card-stats-title"><i class="material-icons">person_outline</i> Total Sales</p>
							   <h4 class="card-stats-number white-text">{{$active_sale_count}}</h4>
							</div>
						 </div>
					  </div>
					  <div class="col s12 m6 l3">
						 <div class="card animate fadeRight">
							<div class="card-content green lighten-1 white-text">
							   <p class="card-stats-title"><i class="material-icons">person_outline</i> Total Booked</p>
		...
		`		   </div>
				 ...
				 <table class="subscription-table responsive-table highlight">
                    ...
                    @foreach($leadlists as $leadlist)
					   <tr>
						  ...
						  <td>{{date('d M Y', strtotime($leadlist->create_date))}}</td>
           ...
           <div class="col s12 m12">
              <div class="card subscriber-list-card animate fadeRight">
                 <div class="card-content pb-1">
                    <h4 class="card-title mb-0">Operator Lead List <i class="material-icons float-right">more_vert</i></h4>
                 </div>
                 <table class="subscription-table responsive-table highlight">
                    <thead>
                       <tr>
                    ...
                    @foreach($leadcounts as $leadcount)
                       <tr>
                          <td>{{$leadcount->name}}</td>
                          <td>{{$leadcount->total_lead}}</td>
                          <td>{{$leadcount->active_lead}}</td>
                          <td>{{$leadcount->inactive_lead}}</td>
                       </tr>
                    @endforeach 
                    @else  
                       <tr>
                          <td colspan="4">No Operator Lead created</td>
                       </tr>
                    @endif
