            ...
            <div class="row">
              <div class="col s10 m6 l6">
                ...
                <ol class="breadcrumbs mb-0">
                  <li class="breadcrumb-item"><a href="index.html">Car Seat</a>
                  </li>
                  <li class="breadcrumb-item"><a href="#">All Car Seat</a>
                  </li>
                </ol>
              </div>
    ...
    <div class="col s12">
      <div class="card">
        <div class="card-content">
			<div class="row">
				<div class="col s6">
					<h4 class="card-title">All Car Seat</h4>
				</div>
              ...
              <table id="multi-select" class="display">
				...
				@foreach($CarSeats as $car)
                  <tr>
                    ...
                    <td>
					<form action="{{ route('carseat.destroy', $car->id) }}" method="POST" style="display: inline-block;">
						{{ csrf_field() }}
