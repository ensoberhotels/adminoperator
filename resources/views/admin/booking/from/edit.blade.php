            ...
            <div class="card">
              <div class="card-content">
                <div class="card-header">
                  <h4 class="card-title">Update Booking From</h4>
                </div>
      
                <form class="add_car_form" id="add_car_form" method="POST" action="{{route('booking_from.update', $data->id )}}" enctype="multipart/form-data" role="form">
                  {{csrf_field()}}
                  <input type="hidden" name="_method" value="PATCH">
                  <div class="row">
                    <div class=" col s12 m2">
                      <label for="car_name" class="">Booking From Title *</label>
