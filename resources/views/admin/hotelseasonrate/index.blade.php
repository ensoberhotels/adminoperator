            ...
            <div class="row">
              <div class="col s10 m6 l6">
                ...
                <ol class="breadcrumbs mb-0">
                  <li class="breadcrumb-item"><a href="index.html">Hotel Season Rate</a>
                  </li>
                  <li class="breadcrumb-item"><a href="#">All Hotel Season Rate</a>
                  </li>
                </ol>
              </div>
      ...
      <div class="card">
        <div class="card-content">
		  ...
		  <div class=" col s12 m2">
		   ...
		   <div class=" col s12 m2">
			  <a href="/admin/hotelseasonrate"><button id="search_hotel" class="btn cyan waves-effect waves-light right" type="button">Clear Search
			  </button></a>
		   </div>
		  </div>
		  </form>
          ...
          <div class="row">
            <div class="col s12">
              <table id="multi-select1" class="dataTable display">
                <thead>
                  <tr>
                    <th class="no-sort">
                      <label>
                    ...
                    <th>Start Date </th>
                    <th>End Date</th>
                    <th>EP Price (<span>&#8377;</span>)</th>                  
                    <th>CP Price  (<span>&#8377;</span>)</th>                  
                    <th>MAP Price (<span>&#8377;</span>)</th>                  
                    <th>AP Price (<span>&#8377;</span>)</th>
                    <th class="no-sort">Status</th>
                    <th class="no-sort" >Action</th>
                  </tr>
                </thead>
                <tbody>
                @foreach($hotel_season_rates as $hotel_season_rate)
                 <tr>
                    <td>
                      <label>
                        <input type="checkbox" />
                    ...
                    <td>{{ $hotel_season_rate->hotel['hotel_name'] }}</td>
                    <td>{{ @$hotel_season_rate->RoomType['room_type'] }}</td>
                    <td>{{ date('d M Y', strtotime($hotel_season_rate->start_date)) }}</td>
                    <td>{{ date('d M Y', strtotime($hotel_season_rate->end_date)) }}</td>
                    <td>{{ $hotel_season_rate->ep_price }}</td>
                    <td>{{ $hotel_season_rate->cp_price }}</td>
                    <td>{{ $hotel_season_rate->map_price }}</td>
                    <td>{{ $hotel_season_rate->ap_price }}</td>
                    <td>
                        <div class="switch">
                          <label onchange="change_status('{{$hotel_season_rate->id}}','HotelSeasonRate')" >
                            @if($hotel_season_rate->status == 'ACTIVE')
                    ...
                    <td>
						<form action="{{ route('hotelseasonrate.destroy', $hotel_season_rate->id) }}" method="POST" style="display: inline-block;">
							{{ csrf_field() }}
                        ...
                        <a href="{{ route('hotelseasonrate.edit',$hotel_season_rate->id) }}">
