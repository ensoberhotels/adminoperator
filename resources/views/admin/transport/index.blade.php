            ...
            <div class="row">
              <div class="col s10 m6 l6">
                ...
                <ol class="breadcrumbs mb-0">
                  ...
                  <li class="breadcrumb-item"><a href="#">All Transport</a>
                  </li>
                </ol>
              </div>
    ...
    <div class="col s12">
      <div class="card">
        <div class="card-content">
			<div class="row">
				<div class="col s6">
					<h4 class="card-title">All Venders</h4>
				</div>
              ...
              <table id="multi-select" class="display">
                <thead>
                  <tr>
                    ...
                    <th>Per KM Fare</th>
                    <th>Car Image</th>
                    <th>Transporter Vender</th>
                    <th class="no-sort">Status</th>
                    <th class="no-sort">Transporter Approved</th>
				...
				@foreach($datas as $data)
                  ...
                  <tr>
                    ...
                    <td>{{ @$data->car_seats->seats }}</td>
                    <td>{{ $data->type }}</td>
                    <td>{{ @$data->countryName->name }}</td>
                    <td>{{ @$data->stateName->name }}</td>
                    <td>{{ @$data->cityName->name }}</td>
                    <td>{{ $data->fare }}</td>
                    <td>{{ $data->perday_km }}</td>
                    <td>{{ $data->perkm_fare }}</td>   
                    <td><a href="{{ url('storage/app/'.@$data->car->car_image) }}" target="_blank"><img src="{{ url('storage/app/'.@$data->car->car_image) }}" width="50px"/></a></td>
                    <td>{{ @$data->venderName->name }}</td>
                    <td>
						<div class="switch">
						  <label onchange="change_status('{{$data->id}}','Transport')">
                    ...
                    <td>
                        <div class="switch">
                          <label onchange="change_approvel('{{$data->id}}','Transport')">
                    ...
                    <td>
                    <form action="{{ route('transport.destroy', $data->id) }}" method="POST" style="display: inline-block;">
						{{ csrf_field() }}
						...
						<a href="{{ route('transport.edit', $data->id) }}">
