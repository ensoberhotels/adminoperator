            ...
            <div class="row">
              <div class="col s10 m6 l6">
                ...
                <ol class="breadcrumbs mb-0">
                  <li class="breadcrumb-item"><a href="index.html">Vender</a>
                  </li>
                  <li class="breadcrumb-item"><a href="#">Add Vender</a>
                  </li>
                </ol>
              </div>
  ...
  <div class="row">
    <div class="col s12 m6 l6 ">
      <div id="basic-form" class="card card card-default scrollspy">
        <div class="card-content">
          <h4 class="card-title">Add Vender</h4>
          <form class="col s12" id="add_vender_form" method="post" action="/admin/addvenderaction">
			{{csrf_field()}}
            <div class="row">
            ...
            <div class="row">
              <div class="input-field col s12">
                <select id="vender_type" name="vender_type">
                  <option value="">Vender Type</option>
                  <option value="HOTEL VENDER">Hotel Vender</option>
                  <option value="EVENT VENDER">Event Vender</option>
                  <option value="TRANSPORT VENDER">Transport Vender</option>
                </select>
                <label for="vender_type">Vender Type</label>
              </div>
            </div>
            <div class="row">
              <div class="input-field col s12">
...
@section('scripts')
	<script>
      //submit...<i class="material-icons right">loop</i>
      jQuery(document).ready(function(){
          
         jQuery("#add_vender").click(function(){
            var formData = jQuery('#add_vender_form').serialize();
            console.log(formData);
            jQuery.ajax({
               type: "post",
               url: "{{URL::to('/admin/addvenderaction')}}",
               data: formData,
