            ...
            <div class="row">
              <div class="col s10 m6 l6">
                ...
                <ol class="breadcrumbs mb-0">
                  ...
                  <li class="breadcrumb-item"><a href="#">Add Activity Name</a>
                  </li>
            ...
            <div class="card">
                <div class="card-content">
                    <div class="card-header">
                        <h4 class="card-title">Create New Activity Name</h4>
                    </div>
					
					
			<form class="add_car_form" id="add_car_form" method="POST" action="{{ route('activityname.store') }}" enctype="multipart/form-data" role="form">
			{{csrf_field()}}
              <div class="row">
                ...
                <div class="col s12 m3">
					...
					<input class="validate invalid" required="" aria-required="true" id="activity_name" type="text" name="activity_name">
                </div>			
