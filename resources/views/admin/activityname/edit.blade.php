            ...
            <div class="row">
              <div class="col s10 m6 l6">
                ...
                <ol class="breadcrumbs mb-0">
                  ...
                  <li class="breadcrumb-item"><a href="#">Edit Activity Name</a>
                  </li>
                </ol>
              </div>
            ...
            <div class="card">
                <div class="card-content">
                    <div class="card-header">
                        <h4 class="card-title">Update Activity Name</h4>
                    </div>
					
					
			<form class="add_car_form" id="add_car_form" method="POST" action="{{route('activityname.update', $activityname->id )}}" enctype="multipart/form-data" role="form">
			{{csrf_field()}}
			<input type="hidden" name="_method" value="PATCH">
              <div class="row">
				<div class="col s12 m3">
					<label for="activity_cat_id" class="">Activity Cat</label>
					<select name="activity_cat_id" class="validate invalid" required="" aria-required="true" id="activity_cat_id">
						...
						@foreach($ActivityCats as $ActivityCat)
							@if($activityname->activity_cat_id == $ActivityCat->id)
                ...
                <div class=" col s12 m3">
					<label for="activity_name" class="">Activity Name *</label>
					<input class="validate invalid" required="" aria-required="true" id="activity_name" type="text" name="activity_name" value="{{ $activityname->activity_name }}">
                </div>
                ...
                <div class="col s12 m3">
                  ...
                  <p>
                    <label>
                      <input class="validate" required="" aria-required="true" value="ACTIVE" name="status" type="radio" @if($activityname->status=='ACTIVE') checked @endif>
                      <span>ACTIVE</span>
                    </label>
                  </p>

                  <label>
                    <input class="validate" required="" aria-required="true" value="INACTIVE" name="status" type="radio" @if($activityname->status=='INACTIVE') checked @endif>
                    <span>INACTIVE</span>
                  </label>
                  <div class="">
                  </div>
