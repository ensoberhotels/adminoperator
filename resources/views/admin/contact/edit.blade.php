...
@section('content')
            ...
            <div class="row">
              <div class="col s10 m6 l6">
                ...
                <ol class="breadcrumbs mb-0">
                  ...
                  <li class="breadcrumb-item"><a href="#">Update Contact</a>
                  </li>
    ...
    <div class="row">
        <div class="col s12">
            ...
            <form class="add_hotel_group_rate_form" id="add_hotel_group_rate_form" method="POST" action="{{ route('contact.update',$Contact->id) }}" >
            {{csrf_field()}}
                    ...
                    <div class="row group">
                        <div class="col s12">
                            <div class="col s12 m2">
                                ...
                                <input class="validate invalid" required="" aria-required="true" id="name" type="text" name="name" value="{{ $Contact->name }}">
                            </div>
                            
                            <div class="col s12 m2">
                                <label for="mobile" class="">Mobile</label>
                                <input class="validate invalid" required="" aria-required="true" id="mobile" type="number" name="mobile" value="{{ $Contact->mobile }}" autocomplete="off">
                             </div> 
                            <div class="col s12 m2">
                                <label for="email" class="">Email</label>
                                <input class="validate invalid" required="" aria-required="true" id="email" type="email" name="email" value="{{ $Contact->email }}">
                            </div>
                            
                            <div class="col s12 m2">
                                <label for="location" class="">Location</label>
                                <input class="validate invalid" required="" aria-required="true" id="googleaddress" type="text" name="location"  value="{{ $Contact->location }}" placeholder="Enter a location" autocomplete="off">
                           ...
                           <div class="col s12 m2">
                            ...
                            <p>
                            <label>
                            <input class="validate" required="" aria-required="true" value="ACTIVE" name="status" type="radio" @if($Contact->status=='ACTIVE') checked @endif>
                            <span>ACTIVE</span>
                            </label>
                            </p>
                            <label>
                            <input class="validate" required="" aria-required="true" value="INACTIVE" name="status" type="radio" @if($Contact->status=='INACTIVE') checked @endif >
                            <span>INACTIVE</span>
                            </label>
