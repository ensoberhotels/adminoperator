    ...
    <div class="col s12">
      <div class="card">
			...
			<div class=" active custom_tab_main tab_border">
				<div class="col s12">
					<ul class="custom_tabs">
						<li class="custom_tab">
							<a class="" href="{{ url('/admin/assigncontact') }}">Assigned Contacts <b style="color:#000;">{{ $total_cont }}</b></a>
						</li>
						<li class="custom_tab">
							<a class="active" href="{{ url('/admin/unassigncontact') }}">Unassigned Contacts <b style="color:#000;">{{ $total_cont_un }}</b></a>
						</li>
					</ul>
				</div>
			</div>
		...
		<div> 
			...
			<div>
				<div class="col s8">
					<label for="assign_to" class="">Select Operator</label>
				...
				<div class="col s4">
					<label for="assign_contact_no" class="">Number Of Contact</label>
					<input class="validate invalid" id="assign_contact_no" name="assign_contact_no" type="text" value="">
				</div>
