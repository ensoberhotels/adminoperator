            ...
            <div class="card">
                <div class="card-content">
                    <div class="card-header">
                        <h3 class="card-title"><strong>Comtact</strong></h3>
                    </div>
                    
                    
            <form class="add_hotel_group_rate_form" id="add_hotel_group_rate_form" method="POST" action="{{ route('contact.store') }}" >
            {{csrf_field()}}
            <!--<input type="hidden" name="contact_type" value="Direct">
            <input type="hidden" name="source" value="CRM Lead">-->
              <div class="row">
                    ...
                    <div class="row group">
                        <div class="col s12"> 
                            <div class="col s12 m2">
                                ...
                                <input class="validate invalid" required="" aria-required="true" id="mobile" type="number" name="mobile" autocomplete="off" value="{{ old('mobile') }}">
                            </div>
							
							<div class="col s12 m2">
                                <label for="agency_name" class="">Agency Name</label>
                                <input class="validate invalid" id="agency_name" type="text" name="agency_name" autocomplete="off" value="{{ old('agency_name') }}">
                            </div>
														
                            <div class="col s12 m2">
                                <label for="name" class="">Name</label>
                                <input class="validate invalid" id="name" type="text" name="name" value="{{ old('name') }}">
                            </div>
                            
                            <div class="col s12 m2">
                                <label for="email" class="">Email</label>
                                <input class="validate invalid" id="email" type="email" name="email" value="{{ old('email') }}">
                            </div>
							
							<div class="col s12 m2">
                                <label for="website" class="">Website</label>
                                <input class="validate invalid" id="website" type="text" name="website" autocomplete="off" value="{{ old('website') }}">
                            </div>
                            
							<div class="col s12 m2">
                                <label for="location" class="">Location</label>
								<input class="validate invalid" id="googleaddress" type="text" name="location" placeholder="Enter a location" autocomplete="off" value="{{ old('location') }}">
                                
                            </div>
							
							<div class="col s12 m2">
                                <label for="contact_type" class="">Contact Type</label>
                                <input class="validate invalid" id="contact_type" type="text" name="contact_type" autocomplete="off" value="Direct">
                            </div>
							
							<div class="col s12 m2">
                                <label for="source" class="">Contact Source</label>
                                <input class="validate invalid" id="source" type="text" name="source" autocomplete="off" value="CRM Lead">
                            </div>
							
							
							<div class="col s12 m2">
                                <label for="additional_info" class="">Additional Info</label>
								<textarea class="validate invalid" id="additional_info" name="additional_info">{{ old('additional_info') }}</textarea>
                            </div>
