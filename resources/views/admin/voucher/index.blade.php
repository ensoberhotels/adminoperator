              ...
              <table id="multi-select" class="display table">
                <thead>
                  <tr>
                    ...
                    <th>Date</th>
                    <th class="no-sort">Hotel Name</th>
                    <th class="no-sort">Agent Name</th>
                    <th class="no-sort">Confirmed By</th>
                    <th class="no-sort">Client Name</th>
                    <th>Check In</th>
                    <th>Check Out</th>
                    <th class="no-sort">No Of Nights</th>
                    <th class="no-sort">No Of Pax</th>
                    <th class="no-sort">Kids</th>
                    <th class="no-sort">No Of Room</th>
                    <th class="no-sort">Room Type</th>
                    <th class="no-sort">Package</th>
                    <th class="no-sort">Cost</th>
                    <th class="no-sort">Advance Received</th>
				...
				@foreach($vouchers as $voucher)
                  <tr>
                    ...
                    <td>{{ $voucher->hotel_name }}
						<a href="{{ url('storage/app/'.$voucher->hotel_logo) }}" target="_blank"><img src="{{ url('storage/app/'.$voucher->hotel_logo) }}" width="50px"/></a>
					</td>
                    <td>{{ $voucher->agent_name }}</td>
                    <td>{{ $voucher->confirmed_by }}</td>
                    <td>{{ $voucher->client_name }}</td>
                    <td>{{ date('d-m-Y', strtotime($voucher->check_in)) }}</td>
                    <td>{{ date('d-m-Y', strtotime($voucher->check_out)) }}</td>
					...
					<form action="{{ route('voucher.destroy', $voucher->id) }}" method="POST" style="display: inline-block;">
						...
						<a href="{{ url('admin/voucher/view', $voucher->id) }}" target="_blank">
							<button class="mb-6 btn-floating waves-effect waves-light gradient-45deg-light-blue-cyan gradient-shadow">
