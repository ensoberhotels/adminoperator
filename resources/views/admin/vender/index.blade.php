            ...
            <div class="row">
              <div class="col s10 m6 l6">
                ...
                <ol class="breadcrumbs mb-0">
                  ...
                  <li class="breadcrumb-item"><a href="#">All Vendor</a>
                  </li>
                </ol>
              </div>
              ...
              <table id="multi-select" class="display">
                ...
                @foreach($venders as $vender)
                  <tr>
                    ...
                    <td>{{ $vender->name }}</td>
                    <td>{{ $vender->email }}</td>
                    <td style="text-transform: lowercase;">{{ $vender->vender_type }}</td>
                    <td>{{ $vender->countryName->name }}</td>
                    <td>{{ $vender->stateName->name }}</td>
                    <td>{{ $vender->cityName->name }}</td>
                    <td>
                        <div class="switch">
                          <label onchange="change_status('{{$vender->id}}','Vender')" >
                            @if($vender->status == 'ACTIVE')
                    ...
                    <form action="{{ route('vender.destroy', $vender->id) }}" method="POST" style="display: inline-block;">
                        {{ csrf_field() }}
                        ...
                        <a href="{{ route('vender.edit', $vender->id) }}">
