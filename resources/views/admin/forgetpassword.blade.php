...
<head>
  ...
  <div class="col s12 m6 l4 z-depth-4 card-panel border-radius-6 login-card bg-opacity-8">
    <form class="login-form" action="{{ URL::to('/admin/sendMail') }}" method="post">
      <div class="row">
      ...
      <div class="row">
        <div class="input-field sm col s12" style="text-align: center;">
			<input type="hidden" name="_token" id="token" value="{{ csrf_token() }}">
          <button type="submit" class="btn waves-effect waves-light border-round gradient-45deg-purple-deep-orange col s6" style="float: none !important;">Submit</button>
        </div>
      </div>
      <!--<div class="row">
