            ...
            <div class="row">
              <div class="col s10 m6 l6">
                ...
                <ol class="breadcrumbs mb-0">
                  ...
                  <li class="breadcrumb-item"><a href="#">All SMTP Emails</a>
                  </li>
                </ol>
              </div> 
    ...
    <div class="col s12">
      <div class="card">
        <div class="card-content">
          ...
          <div class="row">
            <div class="col s12">
              <table id="multi-select" class="display" style="width:100%">
                <thead>
                  <tr>
                    <th class="" >Email</th>                  
                    <th class="" >Password</th>                  
                    <th class="" >SMTP Host</th>                  
                    <th class="" >SMTP Port</th>                  
                    <th class="" >Per Day Limit</th>                  
                    <th class="" >Status</th> 
                ...
                <tr class="animated">
                    <td> {{ $SMTPEmail->email }}</td>
                    <td> {{ $SMTPEmail->password }}</td>
                    <td> {{ $SMTPEmail->host }}</td>
                    <td> {{ $SMTPEmail->port }}</td>
                    <td> {{ $SMTPEmail->per_day_limit }}</td>
                    <td> 
						@if($SMTPEmail->status == 'INACTIVE')
							<b class="status_btn_r">{{ $SMTPEmail->status }}</b>
						@else
							<b class="status_btn_g">{{ $SMTPEmail->status }}</b>
						@endif
					</td>
                    
                    <td>
                    
                    <form action="{{ route('smtpemail.destroy', $SMTPEmail->id) }}" method="POST" style="display: inline-block;">
                        {{ csrf_field() }}
                        ...
                        <a href="{{ route('smtpemail.edit',$SMTPEmail->id) }}">
