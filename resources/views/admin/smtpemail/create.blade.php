...
@section('content')
            ...
            <div class="row">
              <div class="col s10 m6 l6">
                ...
                <ol class="breadcrumbs mb-0">
                  ...
                  <li class="breadcrumb-item"><a href="#">Add SMTP Emails</a>
                  </li>
                </ol>
              </div> 
    ...
    <div class="row">
        <div class="col s12">
            ...
            <form class="add_hotel_group_rate_form" id="add_hotel_group_rate_form" method="POST" action="{{ route('smtpemail.store') }}" >
            {{csrf_field()}}
                    ...
                    <div class="row group">
                        <div class="col s12"> 
                            <div class="col s12 m2">
                                ...
                                <input class="validate invalid" required="" aria-required="true" id="email" type="email" name="email" autocomplete="off" value="{{ old('email') }}">
                            </div>
							
							<div class="col s12 m2">
                                <label for="password" class="">Password</label>
                                <input class="validate invalid" id="password" type="password" name="password" autocomplete="off" value="{{ old('password') }}">
                            </div>
														
                            <div class="col s12 m2">
                                <label for="host" class="">SMTP Host</label>
                                <input class="validate invalid" id="host" type="text" name="host" value="{{ old('host') }}">
                            </div>
                            
                            <div class="col s12 m2">
                                <label for="port" class="">SMTP Port</label>
                                <input class="validate invalid" id="port" type="text" name="port" value="{{ old('port') }}">
                            </div>
							
							<div class="col s12 m2">
                                <label for="per_day_limit" class="">Per Day Limit</label>
                                <input class="validate invalid" id="per_day_limit" type="number" name="per_day_limit" value="{{ old('per_day_limit') }}">
                            </div>
