    ...
    <div class="col s12">
      <div class="card">
        <div class="card-content">
			<div class="row">
				<div class="col s6">
					<h4 class="card-title">All Amenity</h4>
				</div>
              ...
              <table id="multi-select" class="display">
				...
				@foreach($amenities as $amenity)
                  <tr>
                    ...
                    <td>{{ $amenity->name }}</td>
                    <td><a href="{{ url('storage/app/'.$amenity->image) }}" target="_blank"><img src="{{ url('storage/app/'.$amenity->image) }}" width="50px"/></a></td>
					<td>{{ $amenity->paid_status }}</td>
                    <td>
						<div class="switch">
						  <label onchange="change_status('{{$amenity->id}}','Amenity')" >
                    ...
                    <td>
					<form action="{{ route('amenity.destroy', $amenity->id) }}" method="POST" style="display: inline-block;">
						{{ csrf_field() }}
