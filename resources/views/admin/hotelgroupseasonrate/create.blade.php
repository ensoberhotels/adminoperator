            ...
            <div class="row">
              <div class="col s10 m6 l6">
                ...
                <ol class="breadcrumbs mb-0">
                  ...
                  <li class="breadcrumb-item"><a href="#">Add Hotel Group Season Rate</a>
                  </li>
            ...
            <div class="card">
                <div class="card-content">
                    <div class="card-header">
                        <h4 class="card-title">Hotel Group Season Rate</h4>
                    </div>
            <form class="add_hotel_group_rate_form" id="add_hotel_group_rate_form" method="POST" action="{{ route('hotelgroupseasonrate.store') }}" >
            {{csrf_field()}}
              <div class="row">
        ...
        function addMore(){
            $('#details').append(`<div class="row group">
                        <div class="col s11 group_rate"> 
                            ...
                            <div class=" col s12 m2 room_category_id show_select">
								<label class="">Room Category</label>
                                <select name="room_type_id[]" class="validate invalid" required="" aria-required="true" id="">
                                  <option value="">Please Select Room Category</option>
                                </select>
