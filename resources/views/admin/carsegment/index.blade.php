            ...
            <div class="row">
              <div class="col s10 m6 l6">
                ...
                <ol class="breadcrumbs mb-0">
                  ...
                  <li class="breadcrumb-item"><a href="#">All Car Segment</a>
                  </li>
                </ol>
              </div>
    ...
    <div class="col s12">
      <div class="card">
        <div class="card-content">
			<div class="row">
				<div class="col s6">
					<h4 class="card-title">All Car Segment</h4>
				</div>
              ...
              <table id="multi-select" class="display">
				...
				@foreach($car_segments as $car)
                  <tr>
                   ...
                   <!-- <td>
						<div class="switch">
						  <label onchange="change_status('{{$car->id}}','Car')" >
                    ...
                    <td>
					<form action="{{ route('carsegment.destroy', $car->id) }}" method="POST" style="display: inline-block;">
						{{ csrf_field() }}
						...
						<a href="{{ route('carsegment.edit', $car->id) }}">
