            ...
            <div class="row">
              <div class="col s10 m6 l6">
                ...
                <ol class="breadcrumbs mb-0">
                  ...
                  <li class="breadcrumb-item"><a href="#">Add Car Segment</a>
                  </li>
            ...
            <div class="card">
                <div class="card-content">
                    <div class="card-header">
                        <h4 class="card-title">Create New Car Segment</h4>
                    </div>
					
					
			<form class="add_car_form" id="add_car_form" method="POST" action="{{ route('carsegment.store') }}" enctype="multipart/form-data" role="form">
			{{csrf_field()}}
              <div class="row">
				<div class=" col s12 m2">
					<label for="car_segment_id" class="">Car Segmant</label>
            <input type="text" required="" aria-required="true" name="name"/>
                </div>
