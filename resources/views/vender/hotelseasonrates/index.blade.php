              ...
              <table id="multi-select" class="display">
                <thead>
                  <tr>
                    ...
                    <th class="no-sort">Hotel Approved</th>
                ...
                @foreach($hotel_season_rates as $hotel_season_rate)
                 <tr>
                    ...
                    <td>{{ $hotel_season_rate->hotel_name }}</td>
                    <td>{{ $hotel_season_rate->room_type }}</td>
                    ...
                    <td>
                    @if($hotel_season_rate->vender_approved==1)  
                    ...
                    <form action="{{ route('hotelseasonrates.destroy', $hotel_season_rate->id) }}" method="POST" style="display: inline-block;">
                        {{ csrf_field() }}
                    ...
                    @if($hotel_season_rate->vender_approved==1)  
                        ...
                        <a href="{{ route('hotelseasonrates.edit',$hotel_season_rate->id) }}">
