              ...
              <div class="col s10 m6 l6">
                ...
                <ol class="breadcrumbs mb-0">
                 <li class="breadcrumb-item"><a href="#">Activity</a>
                  ...
                  <li class="breadcrumb-item"><a href="#">All Activity Cats</a>
                  </li>
                </ol>
              </div>
    ...
    <div class="col s12">
      <div class="card">
        <div class="card-content">
			<div class="row">
				<div class="col s6">
					<h4 class="card-title">All Activity Cats</h4>
				</div>
              ...
              <table id="multi-select" class="display">
				...
				@foreach($activitycats as $activitycat)
                  <tr>
                    ...
                    <td>{{ $activitycat->activity_cat }}</td>
                    
                    <td>
						<div class="switch">
						  <label onchange="change_status('{{$activitycat->id}}','ActivityCat')">
							@if($activitycat->status == 'ACTIVE')
                    ...
                    <td>
					<form action="{{ route('activitycats.destroy', $activitycat->id) }}" method="POST" style="display: inline-block;">
						{{ csrf_field() }}
						...
						<a href="{{ route('activitycats.edit', $activitycat->id) }}">
