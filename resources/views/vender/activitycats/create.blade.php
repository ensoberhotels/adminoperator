...
@section('content')
    ...
    <div class="row">
        <div class="col s12">
			...
			<form class="add_car_form" id="add_car_form" method="POST" action="{{ route('activitycats.store') }}" enctype="multipart/form-data" role="form">
			{{csrf_field()}}
              <div class="row">
                <div class="input-field col s4">
					<label for="activity_cat" class="">Cat Name *</label>
					<input class="validate invalid" required="" aria-required="true" id="activity_cat" type="text" name="activity_cat">
                </div>			
