            ...
            <div class="row">
              <div class="col s10 m6 l6">
                ...
                <ol class="breadcrumbs mb-0">
                  ...
                  <li class="breadcrumb-item"><a href="#">Edit Activity Cat</a>
                  </li>
                </ol>
              </div>
            ...
            <div class="card">
                <div class="card-content">
                    <div class="card-header">
                        <h4 class="card-title">Update Activity Cat</h4>
                    </div>
					
					
			<form class="add_car_form" id="add_car_form" method="POST" action="{{route('activitycats.update', $activitycat->id )}}" enctype="multipart/form-data" role="form">
			{{csrf_field()}}
			<input type="hidden" name="_method" value="PATCH">
              <div class="row">
                <div class="input-field col s4">
					<label for="activity_cat" class="">Cat Name *</label>
					<input class="validate invalid" required="" aria-required="true" id="activity_cat" type="text" name="activity_cat" value="{{ $activitycat->activity_cat }}">
                </div>
                ...
                <div class="col s12">
                  ...
                  <p>
                    <label>
                      <input class="validate" required="" aria-required="true" value="ACTIVE" name="status" type="radio" @if($activitycat->status=='ACTIVE') checked @endif>
                      <span>ACTIVE</span>
                    </label>
                  </p>

                  <label>
                    <input class="validate" required="" aria-required="true" value="INACTIVE" name="status" type="radio" @if($activitycat->status=='INACTIVE') checked @endif>
                    <span>INACTIVE</span>
                  </label>
