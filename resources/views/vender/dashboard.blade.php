...
@section('styles')
   <link rel="stylesheet" type="text/css" href="{{URL::asset('asset/css/pages/dashboard-modern.css') }}">
   <link rel="stylesheet" type="text/css" href="{{URL::asset('asset/css/pages/intro.css') }}">
   <!-- BEGIN: VENDOR CSS-->
   <link rel="stylesheet" type="text/css" href="{{URL::asset('asset/vendors/vendors.min.css') }}">
   <link rel="stylesheet" type="text/css" href="{{URL::asset('asset/vendors/animate-css/animate.css') }}">
   <link rel="stylesheet" type="text/css" href="{{URL::asset('asset/vendors/chartist-js/chartist.min.css') }}">
   <link rel="stylesheet" type="text/css" href="{{URL::asset('asset/vendors/chartist-js/chartist-plugin-tooltip.css') }}">
    <!-- END: VENDOR CSS-->
@endsection
...
@section('scripts')
   <script src="{{URL::asset('asset/vendors/chartist-js/chartist.min.js') }}" type="text/javascript"></script>
   <script src="{{URL::asset('asset/vendors/chartist-js/chartist-plugin-tooltip.js') }}" type="text/javascript"></script>
   <script src="{{URL::asset('asset/vendors/chartist-js/chartist-plugin-fill-donut.min.js') }}" type="text/javascript"></script>

   <!-- BEGIN PAGE LEVEL JS-->
      <script src="{{URL::asset('asset/js/scripts/dashboard-modern.js') }}" type="text/javascript"></script>
