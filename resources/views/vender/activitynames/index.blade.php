              ...
              <div class="col s10 m6 l6">
                ...
                <ol class="breadcrumbs mb-0">
                 <li class="breadcrumb-item"><a href="#">Activity</a>
                  ...
                  <li class="breadcrumb-item"><a href="#">All Activity Name</a>
                  </li>
                </ol>
              </div>
    ...
    <div class="col s12">
      <div class="card">
        <div class="card-content">
			<div class="row">
				<div class="col s6">
					<h4 class="card-title">All Activity Name</h4>
				</div>
              ...
              <table id="multi-select" class="display">
				...
				@foreach($activitynames as $activityname)
                  <tr>
                    ...
                    <td>{{ $activityname->ActivityCat->activity_cat }}</td>
                    <td>{{ $activityname->activity_name }}</td>
                    
                    <td>
						<div class="switch">
						  <label onchange="change_status('{{$activityname->id}}','ActivityName')" >
							@if($activityname->status == 'ACTIVE')
                    ...
                    <td>
					<form action="{{ route('activitynames.destroy', $activityname->id) }}" method="POST" style="display: inline-block;">
						{{ csrf_field() }}
						...
						<a href="{{ route('activitynames.edit', $activityname->id) }}">
