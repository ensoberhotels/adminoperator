...
@section('content')
    ...
    <div class="row">
        <div class="col s12">
            ...
            <form class="add_car_form" id="add_car_form" method="POST" action="{{ route('transports.store') }}" enctype="multipart/form-data" role="form">
            {{csrf_field()}}            
            ...
            <input type="hidden" name="vender_approved" value="0">
              <div class="row">
                ...
                <div class="input-field col s4">
                  <p>Car Segment : <span id="text_segment"></span></p> 
                  <p>Car Model : <span id="text_model"></span></p> 
                  <p>Car Seats : <span id="text_seats"></span></p> 
