              ...
              <table id="multi-select" class="display">
                ...
                @foreach($datas as $data)
                  ...
                  <tr>
                    ...
                    <td><img src="{{ url('storage/app/'.$data->car->car_image) }}" width="100px"/></td>
                    <td>
                    ...
                    <td>
                    <form action="{{ route('transports.destroy', $data->id) }}" method="POST" style="display: inline-block;">
                        {{ csrf_field() }}
                    ...
                    @if($data->vender_approved==1)
                        <a href="{{ route('transports.edit', $data->id) }}">
