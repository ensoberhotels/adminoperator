    ...
    <div class="col s12">
      <div class="card">
        <div class="card-content">
			<div class="row">
				<div class="col s6">
					<h4 class="card-title">All Activity Sub Cats</h4>
				</div>
              ...
              <table id="multi-select" class="display">
				...
				@foreach($activitysubcats as $activitysubcat)
                  <tr>
                    ...
                    <td>{{ $activitysubcat->activityCat['activity_cat'] }}</td>
                    <td>{{ $activitysubcat->activityName->activity_name }}</td>
                    <td>{{ $activitysubcat->activity_subcat }}</td>
                    <td>{{ $activitysubcat->countryName->name }}</td>
                    <td>{{ $activitysubcat->stateName->name }}</td>
                    <td>{{ $activitysubcat->cityName->name }}</td>
                    
                    <td>
						<div class="switch">
						  <label onchange="change_status('{{$activitysubcat->id}}','ActivitySubCat')" >
							@if($activitysubcat->status == 'ACTIVE')
                    ...
                    <td>
					<form action="{{ route('activitysubcats.destroy', $activitysubcat->id) }}" method="POST" style="display: inline-block;">
						{{ csrf_field() }}
						...
						<a href="{{ route('activitysubcats.edit', $activitysubcat->id) }}">
