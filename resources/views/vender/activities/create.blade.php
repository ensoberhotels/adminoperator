...
@section('content')
    ...
    <div class="row">
        <div class="col s12">
			...
			<form class="add_car_form" id="add_car_form" method="POST" action="{{ route('activities.store') }}" enctype="multipart/form-data" role="form">
			{{csrf_field()}}
            <input type="hidden" name="vender_id" value="{{$vender_id[0]}}">
            <input type="hidden" name="vender_approved" value="0">
			...
			<div class="row" style="margin-bottom:20px;">
				<div class="col s4">
				  ...
				  <div class="col s12 m12 region_list">
				...
				<div class="col s4">
				  ...
				  <div class="col s12 m12 city_list get_suc_cat">
				...
				<div class="col s4">
				  <div class="col s12 m12">
					<p>Activity Sub Cat *</p>
				  </div>
				  <div class="col s12 m12 activity_subcat_list">
