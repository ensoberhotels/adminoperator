...
@section('content')
  ...
  <div class="card">
    <div class="card-content">
      ...
      {{ csrf_field() }}
      <input type="hidden" name="vender_id"  id="vender_id" value="{{$vender_id[0]}}">
      <div class="row"> 
          ...
          <h4 class="card-title">Hotel List  </h4>
            <div class="row" id="hotel_listing">
                ...
                <div class="col s4 hotel_item">
                    ...
                    <div>
                      @if($hotel->vender_approved==0) Vender Not Approved @endif
                     </div>
...
$(document).ready(function(){
  $("#search_hotel").click(function(){
      ...
      var dataValue = {'hotel_name':hotel_name, "country_id": country_id, 'region_id':region_id, 'city_id':city_id,'vender_id':vender_id };
      $.ajaxSetup({
                  headers: {
                      'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                  }
