            ...
            <div class="card">
                <div class="card-content">
                    <div class="card-header">
                        <h4 class="card-title">Create New Amenity</h4>
                    </div>
					
					
			<form class="add_car_form" id="add_car_form" method="POST" action="{{ route('amenities.store') }}" enctype="multipart/form-data" role="form">
			{{csrf_field()}}
              <div class="row">
                <div class="input-field col s4">
					<label for="car_name" class="">Amenity Name *</label>
					<input class="validate invalid" required="" aria-required="true" id="car_name" type="text" name="name">
                </div>			
