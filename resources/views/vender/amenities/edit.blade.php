            ...
            <div class="card">
                <div class="card-content">
                    <div class="card-header">
                        <h4 class="card-title">Update Amenity</h4>
                    </div>
					
					
			<form class="add_car_form" id="add_car_form" method="POST" action="{{route('amenities.update', $amenity->id )}}" enctype="multipart/form-data" role="form">
			{{csrf_field()}}
			<input type="hidden" name="_method" value="PATCH">
              <div class="row">
                <div class="input-field col s4">
					<label for="name" class="">Amenity Name *</label>
					<input class="validate invalid" required="" aria-required="true" id="name" type="text" name="name" value="{{ $amenity->name }}">
                </div>
				<div class="row section">
				  <div class="col s12 m4 l3">
					<p>Set Amenity Base Image</p>
				  </div>
				  @if($amenity->image)
					  <div class="col s12 m4 9">
						<img src="{{ url('storage/app/'.$amenity->image) }}" width="200px"/>
					  </div>
					  <div class="col s12 m4 9">
				...
				<div class="col s4">
				  <div class="col s12 m4 l9">
					<p>Set Amenity Paid Status</p>
				  </div>
				  <div class="col s12 m8 l9">
					<select name="paid_status" class="validate invalid" required="" aria-required="true" id="paid_status">
						<option value="">Select Paid Status</option>
						@if($amenity->paid_status == 'PAID')
                ...
                <div class="col s12">
                  ...
                  <p>
                    <label>
                      <input class="validate" required="" aria-required="true" value="ACTIVE" name="status" type="radio" @if($amenity->status=='ACTIVE') checked @endif>
                      <span>ACTIVE</span>
                    </label>
                  </p>

                  <label>
                    <input class="validate" required="" aria-required="true" value="INACTIVE" name="status" type="radio" @if($amenity->status=='INACTIVE') checked @endif>
                    <span>INACTIVE</span>
                  </label>
