              ...
              <table id="multi-select" class="display">
                <thead>
                  <tr>
                    ...
                    <th class="tooltipped " data-position="top" data-tooltip="Single Sharing Price">S.S Price   (<span>&#8377;</span> )</th>                  
                    <th class="tooltipped " data-position="top" data-tooltip="Double Sharing Price">D.S Price   (<span>&#8377;</span> )</th>                  
                    <th class="tooltipped " data-position="top" data-tooltip="Triple Sharing Price">T.S Price   (<span>&#8377;</span> )</th>                  
                    <th class="tooltipped " data-position="top" data-tooltip="Quad Sharing Price">Q.S Price   (<span>&#8377;</span> )</th>                  
                    <th class="tooltipped " data-position="top" data-tooltip="Penta Sharing Price">P.S Price   (<span>&#8377;</span> )</th>                  
                ...
                <tr>
                    ...
                    <td>
                    @if($group_rate_hotel->vender_approved==1)  
                    ...
                    <form action="{{ route('hotelgroupseasonrates.destroy', $group_rate_hotel->id) }}" method="POST" style="display: inline-block;">
                        {{ csrf_field() }}
                     ...
                     @if($group_rate_hotel->vender_approved==1)  
                        ...
                        <a href="{{ route('hotelgroupseasonrates.edit',$group_rate_hotel->id) }}">
                ...
                <tfoot>
                  <tr>
                    ...
                    <th>To No Person</th>                  
                    <th>Single Sharing Price</th>                  
                    <th>Double Sharing Price</th>                  
                    <th>Triple Sharing Price</th>                  
                    <th>Quad Sharing Price</th>                  
                    <th>Penta Sharing Price</th>                  
                    <th>Status</th>
