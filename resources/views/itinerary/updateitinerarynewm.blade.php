						...
						<div class="col s12" style="padding-left: 25px;">
							<table>
								<tr>
									...
									<td><i class="material-icons">chevron_right</i></td>
									<td> <input type="datetime-local" name="arrival_date_time" id="arrival_date_time" class="filter_date1" autocomplete="off" placeholder="Arrival Date" value="{{$basic_info->arrival_date_time}}"/></td>
								</tr>
								<tr>
									<td>Arrival City</td>
									<td><i class="material-icons">chevron_right</i></td>
								...
								<tr>
									...
									<td><i class="material-icons">chevron_right</i></td>
									<td> <input type="datetime-local" name="drop_date_time" id="drop_date_time" class="filter_date1" autocomplete="off" placeholder="Drop Date" value="{{$basic_info->drop_date_time}}"/></td>
								</tr>
								<tr>
									<td>Drop City</td>
									<td><i class="material-icons">chevron_right</i></td>
								...
								<div class="dis_row">
									<div class="col s6" style="position: relative;">
										...
										@if($route->start_distination == $basic_info->arrival_city)
											<span class="travel_type">Pickup</span>
									...
									<div class="col s6" style="position: relative;">
										...
										@if($route->to_distination == $basic_info->drop_city)
											<span class="travel_type_d">Dropup</span>
									...
									<div class="col s2" >
										<a href="javascript:void(0);" onclick="remove($(this))" style="color: #ff4081;"><i class="material-icons">remove_circle</i></a>
									</div>
								</div>
							@endforeach
	...
	<script>
		...
		function addMore(){
    		...
    		$('#add_more_dis').append(`<div class="dis_row">
									...
									<div class="col s2" >
										<a href="javascript:void(0);" onclick="remove($(this))" style="color: #ff4081;"><i class="material-icons route_area">remove_circle</i></a>
									</div>
								</div>`);
								setTimeout(function(){
